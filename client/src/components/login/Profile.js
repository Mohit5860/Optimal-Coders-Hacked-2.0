...
const Profile = () => {
  ...
  return (
    <div>
      <div className="my-10 mx-72 flex">
        <div>
        ...
        <div className="mx-60 my-5">
          <p className="text-3xl p-2">Name : {data?.name}</p>
          <p className="text-3xl p-2">Email : {data?.email}</p>
          <p className="text-3xl p-2">Blood Group : {data?.bloodType}</p>
          <p className="text-3xl p-2">City : {data?.city}</p>
          <p className="text-3xl p-2">Pincode : {data?.pincode}</p>
        </div>
      </div>
    </div>
  );
